...
<template>
    <AuthBase>
        ...
        <Form v-bind="store.form()" :reset-on-success="['password']" v-slot="{ errors, processing }"
            class="flex flex-col gap-6 bg-white/70 rounded-xl shadow-xl px-6 py-8 border border-gray-100 max-w-md md:max-w-2xl lg:max-w-3xl mx-auto w-full transition-all opacity-0 translate-y-6 duration-700"
            ...
            <div class="flex flex-col gap-5 opacity-0 translate-y-6 transition-all duration-700 delay-300"
                ...
                <div class="flex items-center gap-2 mt-2">
                    ...
                    <Label for="remember" class="cursor-pointer font-normal text-black">
                        Recordarme
                    </Label>
                </div>
